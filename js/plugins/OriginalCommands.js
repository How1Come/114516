  ...
  Game_Interpreter.prototype.pluginCommand = function(command, args) {
    ...
    if (command === 'FaceId') {//表情表示用
      ...
      if (command === 'CallPurpose') {
        ...
        {var ActorID = 80
          $gameActors.actor(80).setName("")
          $gameActors.actor(81).setName("")
          $gameActors.actor(82).setName("")
        }
        else if(PurNum == 5){var ActorID = 81}
        else if(PurNum == 6){var ActorID = 82}
        ...
        if(PurNum <= 1){
          ...
          $gameVariables._data[2953] = '催眠线的目的已经更新了。'
          this.setupChild($dataCommonEvents[97].list, 0)
        }
      }
