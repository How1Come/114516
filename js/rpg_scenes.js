...
Scene_Equip.prototype.onItemOk = function() {
    ...
    if([2,3].includes(this._slotWindow.index()) && !$gameSwitches.value(131)){
		TickerManager.show(`未变身无法装备`);
		this._slotWindow.activate();
		this._slotWindow.refresh();
		this._itemWindow.deselect();
		this._itemWindow.refresh();
...
Scene_Battle.prototype.createPartyCommandWindow = function() {
    ...
    this._partyCommandWindow.setHandler('eroSelf', this.commandEroSelf.bind(this));
...
Scene_Battle.prototype.commandEroSelf = function() {
    $gameSwitches._data[2925] = true;
